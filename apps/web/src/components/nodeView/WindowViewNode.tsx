...
import { NodeViewData } from "@bt/shared/context/index";
 ...
 * Reemplazado por: <VideoDetailScreen>.
    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      ...
      <DialogContent dividers ref={contentRef} sx={{ overflowY: "auto" }}>
        <Box sx={youtubeWrapper}>
          {" "}
          {nodeData?.videoid && nodeData.videoid.length > 30 ? (
            <iframe
        ...
        <Divider sx={{ my: 2 }} /> {/* Relaciones entre nodos */}
